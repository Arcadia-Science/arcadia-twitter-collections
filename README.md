...
# The following variables are Airtable field IDs for the fields described above in 'Getting started'
...
To get the relevant environment variables for Airtable, use the [web API documentation](https://airtable.com/developers/web/api/introduction). Select your base, and navigate to the table where your Twitter collections are stored to gather the table IDs and field IDs.
